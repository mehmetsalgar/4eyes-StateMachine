...
#fsm-***-advice
mkdir "fsm-$1-advice"
mkdir -p "fsm-$1-advice/src/main/mwe2"
...
sed "s|4eyes|$1|g" "fsm-4eyes-statemachine/build.gradle" > "fsm-$1-statemachine/build.gradle"
...
sed "s|4eyes|$1|g" "fsm-4eyes-actionguard-impl/build.gradle" > "fsm-$1-actionguard-impl/build.gradle"
...
mkdir -p "fsm-$1-statemachine-facade/src/main/mwe2"
...
sed "s|4eyes|$1|g" "fsm-4eyes-statemachine-facade/build.gradle" > "fsm-$1-statemachine-facade/build.gradle"
rm -fR "fsm-4eyes-statemachine-facade"

#fsm-***-model
mkdir "fsm-$1-model"
mkdir -p "fsm-$1-model/src/main/mwe2"
sed "s|4eyes|$1|g" "fsm-4eyes-model/build.gradle" > "fsm-$1-model/build.gradle"
...
sed "s|4eyes|$1|g" "fsm-4eyes-protobuf/build.gradle" > "fsm-$1-protobuf/build.gradle"
...
sed "s|4eyes|$1|g" "fsm-4eyes-converter/build.gradle" > "fsm-$1-converter/build.gradle"
...
sed "s|4eyes|$1|g" "fsm-4eyes-command/build.gradle" > "fsm-$1-command/build.gradle"
...
sed "s|4eyes|$1|g" "fsm-4eyes-kafka/build.gradle" > "fsm-$1-kafka/build.gradle"
...
sed "s|4eyes|$1|g" "fsm-4eyes-elasticsearch-statemachine-adapter/build.gradle" > "fsm-$1-elasticsearch-statemachine-adapter/build.gradle"
...
sed "s|4eyes|$1|g" "fsm-4eyes-projections-statemachine-adapter/build.gradle" > "fsm-$1-projections-statemachine-adapter/build.gradle"
...
mkdir -p "fsm-$1-projections/src/main/mwe2"
...
sed "s|4eyes|$1|g" "fsm-4eyes-projections/build.gradle" > "fsm-$1-projections/build.gradle"
...
sed "s|4eyes|$1|g" "fsm-4eyes-application/build.gradle" > "fsm-$1-application/build.gradle"
...
sedStarterCommand="${sedStarterCommand}/SMCommand/d;"
...
sedAsciiDocMwe="${sedAsciiDocMwe}s|4eyes|$1|g"
...
sed "s|4eyes|$1|g" "fsm-4eyes-asciidoc/build.gradle" > "fsm-$1-asciidoc/build.gradle"
rm -fR "fsm-4eyes-asciidoc"
